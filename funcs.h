public char * save LESSPARAMS ((const char *s));
...
public LWCHAR get_wchar LESSPARAMS ((const char *p));
public void put_wchar LESSPARAMS ((char **pp, LWCHAR ch));
public LWCHAR step_char LESSPARAMS ((char **pp, signed int dir, const char *limit));
...
public void cmd_putstr LESSPARAMS ((const char *s));
public int len_cmdbuf LESSPARAMS ((VOID_PARAM));
public void set_mlist LESSPARAMS ((void *mlist, int cmdflags));
public void cmd_addhist LESSPARAMS ((struct mlist *mlist, const char *cmd, int modified));
...
public void skip_ansi LESSPARAMS ((char **pp, const char *limit));
...
public void putstr LESSPARAMS ((const char *s));
...
public char * pr_expand LESSPARAMS ((const char *proto, int maxwidth));
